...
for i = 1 : nElem
    ...
    a = coordinates(elements(i,1),1:2);  % start node coordinates [x1 y1]
    b = coordinates(elements(i,2),1:2);  % end node coordinates   [x2 y2]
    ...
    % TODO: (a) calculating length
    % L = 
    
    
    % TODO: (b) local stiffness matrix
    % k_bar = 
    
    
    % TODO: (c) transformation matrix
    % c = 
    % s =  
    % T = 
     
    
    % TODO: (d) element stiffness matrix in global coordinates:
    % k = 
