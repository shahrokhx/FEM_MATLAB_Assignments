...
% TODO:  (a) Initialize total stiffness matrix
% K = 
...
for i = 1 : nElem
    ...
    k_bar = E(i)*A(i)/L   *   [1 -1; -1 1];
    
    
    % transformation matrix
    c = (x2 - x1)/L;  % cos(t) = (x2 - x1)/L
    s = (y2 - y1)/L;  % sin(t) = (y2 - y1)/L   
    T = [c s 0 0; 0 0 c s];
...
% TODO: (c) re-shaping matrix f to obtain the nodal force vector
f = [fx, fy]
% F = ...
...
% TODO: (d) solving Ku=F (before imposing bounday conditions) 
% u = 
% TODO: Explain why you get this results?
% 
%
%
...
% TODO: (e) imposing boundary conditions
bc = [rx, ry]
...
% TODO: (f) solving Ku=F to obtain displacement vector {u} 
% u =
